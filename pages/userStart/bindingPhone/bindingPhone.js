...
Page({
  ...
  login(e){
    ...
    if (e.detail.rawData!=undefined){
      this.setData({ udata: JSON.parse(e.detail.rawData)});
    }
    ...
    api.getOpenid({
      ...
      invitation:'',
      nickName: this.data.udata != null ? this.data.udata.nickName : '',
      avatar: this.data.udata != null ? this.data.udata.avatarUrl : '',
    }).then((res) => {
      console.log()
      if (res.data.Code == 200) {
        ...
        wx.redirectTo({
          url: './../../usercenter/index/index?isInvite=' + res.data.Data.isInvite          
            // url: './../../About/Aboutclass/Aboutclass'
        });
        // }else{
        //   wx.redirectTo({
        //     // url: './../../usercenter/index/index?isInvite=' + res.data.Data.isInvite
        //     // pages/attendClass/attendClass
