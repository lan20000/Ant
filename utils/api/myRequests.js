...
//经纬度查询店铺
const checkPhoneCode = (data, url = 'Login/CheckPhoneCode') => { return myRequest(data, url) }
...
//获取scctoken
const accessToken = (data, url = 'login/GetAccessKey') => { return myRequest(data, url, 'get') }
